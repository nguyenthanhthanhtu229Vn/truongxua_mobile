  ...
  const createDonate = async (headers) => {
    try {
      ...
      if (response.status === 200) {
        ...
        alert("Quyên Góp Thành Công! Mời Bạn Tiếp Tục Tham Gia Sự Kiện");
      }
    } catch (error) {
      alert(error);
    }
  ...
  return (
    ...
    <View style={{ marginTop: 40, flex: 1, backgroundColor: "white" }}>
      ...
      <View style={{ marginHorizontal: 10, flexDirection: 'column' }}>
        ...
        >
          <View style={{flexDirection: 'row', width: 200, alignItems:'center', justifyContent: 'space-between'}}>
          <CircleCheckBox
        ...
        >
          ...
          <Image
            source={icons.visa}
            style={{ height: 30, width: 30, position: "relative", right: 10 }}
          />
          </View>
          ...
          >
            ...
            >
              ...
              >
                ...
                <Text
                  style={{ color: "#0170BA", fontWeight: "600", fontSize: 16 }}
                >
                  Xem các điều khoản
                </Text>
              </Text>
